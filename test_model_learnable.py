...
from model_learnable import SA_net
import kaolin
...
if __name__ == '__main__':
    ...
    if not os.path.isdir("result"):
        os.mkdir("result")
    if not os.path.isdir("./result/model_learnable"):
        os.mkdir("./result/model_learnable")
    for i in range(100):
        path = "./result/model_learnable/model_learnable_" + str(i) + ".png"
